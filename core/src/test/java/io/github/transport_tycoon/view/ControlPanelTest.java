...
public class ControlPanelTest {
    ...
    @Mock private ControlPanel.SpeedChangeListener mockSpeedListener;
    @Mock private ControlPanel.BuildModeListener mockBuildListener;
    @Mock private ControlPanel.BuildStopListener mockBuildStopListener;
    @Mock private ControlPanel.VehicleWindowListener mockVehicleWindowListener;
    ...
    public void setUp() {
        ...
        controlPanel = new ControlPanel(mockBatch);
        controlPanel.setSpeedChangeListener(mockSpeedListener);
        controlPanel.setBuildListener(mockBuildListener);
        controlPanel.setBuildStopListener(mockBuildStopListener);
        controlPanel.setVehicleWindowListener(mockVehicleWindowListener);
    }
    ...
    public void testInitialization() {
        assertNotNull(controlPanel.getStage());
    }

    @Test
    public void testRender() {
        controlPanel.render();
        verify(Gdx.graphics).getDeltaTime();
    }

    @Test
    public void testResize() {
        controlPanel.resize(800, 600);
        assertNotNull(controlPanel.getStage().getViewport());
    }
